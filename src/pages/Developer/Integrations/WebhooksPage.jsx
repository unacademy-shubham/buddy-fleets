...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Configure outbound and inbound webhook endpoints, signing, retry policies and delivery logs.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Configure outbound and inbound webhook endpoints, signing, retry policies and delivery logs.
            </p>
          </div>
