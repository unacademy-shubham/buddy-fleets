...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Monitor Supabase/database availability, API layers, Edge Functions and critical backend dependencies.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Monitor Supabase/database availability, API layers, Edge Functions and critical backend dependencies.
            </p>
          </div>
          ...
          <div className="text-[12px] font-medium text-white/80">
            ...
            <span className="text-white">Database & APIs</span>
          </div>
        </div>
      </section>
