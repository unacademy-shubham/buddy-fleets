...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Central security control for secure login, portal sessions, MFA, account locks and privileged access.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Central security control for secure login, portal sessions, MFA, account locks and privileged access.
            </p>
          </div>
