...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Review authenticated sessions, active devices, session age and revoke controls.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Review authenticated sessions, active devices, session age and revoke controls.
            </p>
          </div>
          ...
          <div className="text-[12px] font-medium text-white/80">
            ...
            <span className="text-white">Auth & Sessions</span>
          </div>
        </div>
      </section>
