...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Manage all customer companies, tenant lifecycle, status, plans, users, vehicles, modules, renewals and suspension controls.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Manage all customer companies, tenant lifecycle, status, plans, users, vehicles, modules, renewals and suspension controls.
            </p>
          </div>
          ...
          <div className="text-[12px] font-medium text-white/80">
            ...
            <span className="text-white">Company Management</span>
          </div>
        </div>
      </section>
