...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Configure module access, user limits, vehicle limits, storage limits and role-based plan entitlements.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Configure module access, user limits, vehicle limits, storage limits and role-based plan entitlements.
            </p>
          </div>
          ...
          <div className="text-[12px] font-medium text-white/80">
            ...
            <span className="text-white">Limits & Access</span>
          </div>
        </div>
      </section>
