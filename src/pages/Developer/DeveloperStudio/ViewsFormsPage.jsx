...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Configure list views, detail views, forms, dashboards and reusable module UI surfaces.',
    status: 'active',
  },
  {
    title: 'Configuration',
...
export default function ViewsFormsPage() {
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Configure list views, detail views, forms, dashboards and reusable module UI surfaces.
            </p>
          </div>
          ...
          <div className="text-[12px] font-medium text-white/80">
            ...
            <span className="text-white">Views & Forms</span>
          </div>
        </div>
      </section>
