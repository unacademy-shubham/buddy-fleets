...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Configure fields, validation rules, relationships, calculations and file properties for metadata-driven modules.',
    status: 'active',
  },
  {
    title: 'Configuration',
...
export default function SchemasFieldsPage() {
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Configure fields, validation rules, relationships, calculations and file properties for metadata-driven modules.
            </p>
          </div>
          ...
          <div className="text-[12px] font-medium text-white/80">
            ...
            <span className="text-white">Schemas & Fields</span>
          </div>
        </div>
      </section>
