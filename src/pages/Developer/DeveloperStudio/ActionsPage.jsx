...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Configure registered actions such as notifications, state changes, integrations and internal operations.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Configure registered actions such as notifications, state changes, integrations and internal operations.
            </p>
          </div>
          ...
          <div className="text-[12px] font-medium text-white/80">
            ...
            <span className="text-white">Workflow Actions</span>
          </div>
        </div>
      </section>
