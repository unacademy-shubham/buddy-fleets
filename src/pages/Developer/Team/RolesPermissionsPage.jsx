...
const SAMPLE_ITEMS = [
  {
    title: 'Overview',
    text: 'Define SUPER_ADMIN, SALES_ADMIN, SUPPORT_ADMIN and future internal role permissions.',
    status: 'active',
  },
  {
    title: 'Configuration',
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 max-w-3xl text-[13px] leading-5 text-white/80">
              Define SUPER_ADMIN, SALES_ADMIN, SUPPORT_ADMIN and future internal role permissions.
            </p>
          </div>
